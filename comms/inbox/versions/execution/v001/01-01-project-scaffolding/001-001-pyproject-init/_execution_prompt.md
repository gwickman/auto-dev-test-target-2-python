...
```bash
git checkout -b v001/01-01-project-scaffolding/001-001-pyproject-init
```
...
**Feature:** 001-001-pyproject-init

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/01-01-project-scaffolding/001-001-pyproject-init/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/01-01-project-scaffolding/001-001-pyproject-init/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/01-01-project-scaffolding/001-001-pyproject-init/`:
