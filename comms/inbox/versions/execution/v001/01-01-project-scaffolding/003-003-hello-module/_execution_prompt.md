...
```bash
git checkout -b v001/01-01-project-scaffolding/003-003-hello-module
```
...
**Feature:** 003-003-hello-module

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/01-01-project-scaffolding/003-003-hello-module/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/01-01-project-scaffolding/003-003-hello-module/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/01-01-project-scaffolding/003-003-hello-module/`:
